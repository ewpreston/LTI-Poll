      ...
      "@graph": [
        {
          ...
          title:
            "Week 1 reading LTI + Link<script>alert('help me');</script>&nbsp;<span style=\"font-family: Garamond; font-weight: bold; font-size: 24px\">Hello</span>",
          text:
            "Read this section prior to your tutorial. <script>alert('help me');</script>&nbsp;<span style=\"font-family: Garamond; font-weight: bold; font-size: 24px\">This should be large and bold</span>",
          custom: {
            chapter: "12",
            section: "3",
